...
<!-- badges: start -->
[![R-CMD-check](https://github.com/bdesmarais/palsr/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/bdesmarais/palsr/actions/workflows/R-CMD-check.yaml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
<!-- badges: end -->

**palsr** implements the **Projected Actor Location (PALS)** method for spatial
...
If you use **palsr**, please cite the method paper:

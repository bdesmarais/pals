...
This paper introduces \pkg{palsr}, an R package that turns PALS into reusable,
...
developed openly and is available from \url{https://github.com/bdesmarais/palsr};
its replication archive and the underlying method are documented in
\citet{kim2023pals}.
